    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {data.client.status === 'INACTIVE' && (
                  <div className="px-6 py-3 bg-red-100 border-2 border-red-500 rounded-lg">
                    <div className="flex items-center gap-2">
                      <span className="text-2xl">⚠️</span>
                      <div>
                        <p className="text-red-900 font-bold text-lg">CLIENTE INACTIVO</p>
                        <p className="text-red-700 text-xs">No se generarán mantenciones</p>
                      </div>
                    </div>
                  </div>
                )}
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Right Column - Maintenance Timeline (only show for active clients) */}
